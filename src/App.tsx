...
const App = ({}: Props) => {
  ...
  const {hfUserInfo: {name: userName, id: userId}, hfToken} = useHfClient(enteredAccessToken, spaceId, (isLoading) => setSettingsLoading(isLoading), (msg: string) => setErrorSnackbarMessage(msg))
