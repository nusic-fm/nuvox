...
const viewsData = [
  [388, 446, 488, 433, 350, 390, 460, 500, 560, 600], // 4555
  [320, 375, 420, 380, 315, 345, 400, 435, 485, 525], // 3930
  [450, 495, 525, 470, 445, 425, 485, 520, 580, 620], // 4900
  [365, 410, 445, 395, 390, 385, 425, 460, 510, 550], // 4200
  [365, 465, 505, 450, 285, 415, 475, 515, 575, 615], // 4715
  [340, 385, 425, 395, 365, 350, 410, 445, 495, 535], // 4030
  [425, 480, 515, 460, 435, 415, 470, 525, 585, 625], // 4830
  [355, 400, 435, 390, 375, 360, 420, 455, 505, 545], // 4135
  [415, 470, 510, 455, 430, 410, 475, 520, 580, 620], // 4770
  [335, 380, 415, 375, 360, 345, 405, 440, 490, 530], // 3970
  [445, 500, 535, 480, 455, 435, 495, 540, 600, 640], // 5010
  [375, 420, 455, 410, 395, 380, 440, 475, 525, 565], // 4335
  [345, 450, 490, 435, 415, 375, 465, 505, 565, 605], // 4600
  [350, 395, 430, 385, 370, 355, 415, 450, 500, 540], // 4085
  [435, 490, 525, 470, 445, 425, 485, 530, 590, 630], // 4910
  [360, 405, 440, 395, 380, 365, 425, 460, 510, 550], // 4185
  [410, 465, 500, 445, 420, 400, 470, 515, 575, 615], // 4690
  [345, 390, 425, 380, 365, 350, 410, 445, 495, 535], // 4035
  [420, 475, 510, 455, 430, 410, 480, 525, 585, 505], // 4795
];
const creationsData = [
  [188, 246, 288, 233, 210, 190, 260, 300, 360, 442], // 2457
  [170, 225, 270, 230, 205, 195, 250, 285, 335, 356], // 2333
  [250, 295, 325, 270, 245, 225, 285, 320, 380, 400], // 2807
  [165, 210, 245, 195, 180, 175, 225, 260, 310, 330], // 2111
  [185, 265, 305, 250, 225, 205, 275, 315, 375, 405], // 2618
  [140, 185, 225, 195, 165, 150, 210, 245, 295, 325], // 1943
  [225, 280, 315, 260, 235, 215, 270, 325, 385, 425], // 2747
  [155, 200, 235, 190, 175, 160, 220, 255, 305, 335], // 2059
  [215, 270, 310, 255, 230, 210, 275, 320, 380, 408], // 2673
  [135, 180, 215, 175, 160, 145, 205, 240, 290, 328], // 1883
  [245, 300, 335, 280, 255, 235, 295, 340, 400, 424], // 2921
  [175, 220, 255, 210, 195, 180, 240, 275, 325, 351], // 2246
  [185, 250, 290, 235, 215, 195, 265, 305, 365, 392], // 2507
  [150, 195, 230, 185, 170, 155, 215, 250, 300, 347], // 1997
  [235, 290, 325, 270, 245, 225, 285, 330, 390, 429], // 2824
  [160, 205, 240, 195, 180, 165, 225, 260, 310, 359], // 2099
  [210, 265, 300, 245, 220, 200, 270, 315, 375, 403], // 2603
  [145, 190, 225, 180, 165, 150, 210, 245, 295, 341], // 1946
  [220, 275, 310, 255, 230, 210, 280, 325, 385, 416], // 2706
  [130, 175, 215, 170, 155, 140, 200, 235, 285, 333], // 1838
];

const playedMsData = [
  6617945, 6680419, 6334648, 5769970, 2849958, 1132135, 5044738, 3382610,
  1169347, 1679153, 3140865, 2324400, 7466242, 7391445, 5883311, 2451701,
  4308444, 6337101,
];
                    ...
                    <Box display={"flex"} gap={4}>
                      ...
                      >
                        ...
                        <Stack gap={2}>
                          ...
                          >
                            {playedMsData[selectedVoiceModelIdx]}ms{" "}
                            {(
                              playedMsData[selectedVoiceModelIdx] / 1000
                            ).toFixed(0)}{" "}
                            $NUSIC
                          </Typography>
                        </Stack>
